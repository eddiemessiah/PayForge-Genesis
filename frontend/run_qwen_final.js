  ...
  try {
    const res = await fetch(BASE_URL, {
      ...
      body: JSON.stringify({
        ...
        messages: [
          { role: "system", content: "You are an expert UI developer building a Fortune 500 Web3 app. Output ONLY valid, complete Next.js TSX code. Do not use markdown ```tsx wrappers. Use Tailwind classes (bg-[#050B08], text-emerald-400), lucide-react icons, and export default function format." },
    ...
    if (data.error) {
      console.error("0G API Error:", data.error);
      return;
    }
...
6. A premium Footer.
Use lucide-react icons. Lots of padding, large typography, dark emerald theme.`;
