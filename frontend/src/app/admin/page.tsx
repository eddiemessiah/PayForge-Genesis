...
import { 
  ...
  BarChart4, ArrowUpRight, EyeOff, CheckCircle2, Loader2, Database, X
} from "lucide-react";
      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden bg-[url('/noise.png')] bg-repeat bg-[length:100px_100px] bg-blend-overlay">
        ...
        <div className="flex-1 overflow-y-auto p-4 md:p-8 space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            {/* Encrypted Cap Table */}
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.1 }} className="lg:col-span-2 bg-[#050B08] border border-white/5 rounded-[2rem] flex flex-col overflow-hidden">
